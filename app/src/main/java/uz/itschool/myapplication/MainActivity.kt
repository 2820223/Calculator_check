...
//        (-8)
    ...
    fun initui(){
        ...
        del=findViewById(R.id.delete_last)
        equal=findViewById(R.id.teng)
        show_num=findViewById(R.id.operand)
        show_answer=findViewById(R.id.result)
        div=findViewById(R.id.boluv)
        multply=findViewById(R.id.kopaytiruv)
        clear=findViewById(R.id.c)
        plus=findViewById(R.id.plus)
        minus=findViewById(R.id.minus)
        percentage=findViewById(R.id.foiz)
        plus_or_minus=findViewById(R.id.qavs_minus)
